import { useNavigation } from "@react-navigation/native"; // ✅ React Navigation ONLY
    ...
    <View style={{ paddingTop: insets.top, backgroundColor: "#0a1220e1a" }}>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          style={styles.addBtn}
          onPress={() => {
            console.log("HEADER ADD CAR CLICKED");
            navigation.navigate("add-car"); // ✅ Stack navigator
          }}
        >
...
const CarCard = memo(({ car }: { car: Car }) => {
  const navigation = useNavigation<any>(); // ✅ React Navigation (replace expo-router)
  const mainPhoto = car.photos[0] || null;

  return (
    <TouchableOpacity
      style={styles.card}
      onPress={() => navigation.navigate("car-details", { id: car.id })} // ✅ React Nav params
    >
      {mainPhoto ? (
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        style={styles.fab}
        onPress={() => {
          console.log("FAB ADD CAR CLICKED");
          navigation.navigate("add-car"); // ✅ Stack navigator
        }}
      >
